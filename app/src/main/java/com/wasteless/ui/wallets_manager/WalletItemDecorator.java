...
public class WalletItemDecorator extends RecyclerView.ItemDecoration {
     ...
     */
    public WalletItemDecorator(Context context) {
     ...
     */
    public WalletItemDecorator(Context context, int resId) {
